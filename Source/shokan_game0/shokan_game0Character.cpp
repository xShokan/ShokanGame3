...
void Ashokan_game0Character::Tick(float DeltaTime)
{
	...
	if (!isHip)
	{
		...
		UKismetSystemLibrary::LineTraceSingle(this, FireStart, FireEnd, ETraceTypeQuery::TraceTypeQuery1, false, ActorToIgnore, EDrawDebugTrace::ForOneFrame, OutHit, true);
